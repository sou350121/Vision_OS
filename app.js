...
class VisionOS {
    ...
    getFingerExtension(landmarks, indices) {
        ...
        // Measure joint angles at PIP and DIP
        ...
        // Map Angle: 110 (Bent) -> 0% to 155 (Straight) -> 100%
        // Using 155 as 100% because perspective in 2D often compresses straight fingers to <170
        return Math.max(0, Math.min(100, (avgAngle - 110) * 2.2));
    }
