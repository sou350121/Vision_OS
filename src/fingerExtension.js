 ...
 * 
 * @param {Array} landmarks - Array of 21 hand landmarks from MediaPipe
 * @returns {number} Spread value 0-100
 */
export function getThumbSpread(landmarks) {
    const tipThumb = landmarks[4];
    const wrist = landmarks[0];
 ...
 * 
 * @param {Array} landmarks - Array of 21 hand landmarks from MediaPipe
 * @returns {Object} {mcp, pip, dip} - Each 0-100 (100 = straight, 0 = bent)
 */
export function getIndexJoints(landmarks) {
    const wrist = landmarks[0];
